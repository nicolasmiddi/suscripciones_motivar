...
public function InsertarExcel_Temporal ($insert){
	...
	public function TablaSuscriptosDulpicadosModel (){
			$stmt = Conexion::conectar()->prepare("SELECT sug_id, sug_nombre, sug_apellido, sug_correo_1, count(sug_id) as contador
													FROM sus_usuario_gral
													INNER JOIN sus_suscripciones ON ssu_id = sug_id
                                                    INNER JOIN sus_tmp_excel ON sug_correo_1 = tmp_correo_1
                                                    GROUP BY sug_id");
		$stmt -> execute();
		return $stmt -> fetchAll();
		$stmt -> close();
	...
	public function TablaSuscriptosDulpicadosTemporalModel (){
			$stmt = Conexion::conectar()->prepare("SELECT tmp_correo_1 as correo, count(tmp_correo_1) as contador
													FROM sus_tmp_excel
													-- WHERE tmp_id_importacion > 1
													GROUP BY tmp_correo_1
													HAVING count(tmp_correo_1) >1
	...
	public function SuscriptosDulpicadosTemporalxVariableModel ($datos){
			$stmt = Conexion::conectar()->prepare("SELECT *
													FROM sus_tmp_excel
													INNER JOIN sus_tmp_tablas on tmt_id = tmp_id_importacion
													WHERE tmp_correo_1 = '$datos'
	...
	public function SuscriptosDulpicadosActivoTemporalxVariableModel ($id){
			$stmt = Conexion::conectar()->prepare("SELECT tmp_id, tmp_id_importacion, tmp_nombre, tmp_apellido, tmp_correo_1, tmp_correo_2, tmp_telefono_1, tmp_telefono_2, tmp_celular, tmp_nacimiento, tmp_dni, tmp_tipo_direccion, tmp_calle, tmp_numero, tmp_piso_dpto, tmp_cp, tmp_localidad, tmp_partido, tmp_ciudad, tmp_provincia, tmp_pais, tmp_formacion_profesional, tmp_formacion_carrera, tmp_formacion_institucion, tmp_empresa_nombre, tmp_empresa_actividad, tmp_empresa_area, tmp_empresa_cargo, tmp_empresa_web, tmp_institucion_nombre, tmp_institucion_departamento, tmp_institucion_cargo, tmp_independiente, tmp_actividad_veterinaria, tmp_actividad_industria, tmp_actividad_agropecuaria, tmp_actividad_dueno, tmp_actividad_peq_animales, tmp_actividad_gran_animales, tmp_intereses_1, tmp_intereses_2, tmp_intereses_3, tmp_intereses_4, tmp_intereses_5, tmp_consumidor_final_pets, tmp_observaciones, tmp_sus_mot_digital, tmp_sus_2mas2_digital, tmp_sus_mot_impreso, tmp_sus_2mas2_impreso, tmp_sus_tipo_envio, tmp_sus_envios_enero, tmp_sus_envios_febrero, tmp_sus_envios_marzo, tmp_sus_envios_abril, tmp_sus_envios_mayo, tmp_sus_envios_junio, tmp_sus_envios_julio, tmp_sus_envios_agosto, tmp_sus_envios_septiembre, tmp_sus_envios_octubre, tmp_sus_envios_noviembre, tmp_sus_envios_diciembre, tmp_sus_invitado_CIVA, tmp_fuente, tmp_ultima_actualizacion, tmp_ejemplos, tmp_observaciones2, tmt_fecha
													FROM sus_usuario_gral
								INNER JOIN sus_suscripciones ON ssu_id = sug_id
                                 INNER JOIN sus_tmp_excel ON sug_correo_1 = tmp_correo_1
                                 INNER JOIN sus_tmp_tablas ON tmt_id = tmp_id_importacion
	...
	public function FullSuscriptorActivo ($id){
			$stmt = Conexion::conectar()->prepare("SELECT tmp_id, tmp_id_importacion, tmp_nombre, tmp_apellido, tmp_correo_1, tmp_correo_2, tmp_telefono_1, tmp_telefono_2, tmp_celular, tmp_nacimiento, tmp_dni, tmp_tipo_direccion, tmp_calle, tmp_numero, tmp_piso_dpto, tmp_cp, tmp_localidad, tmp_partido, tmp_ciudad, tmp_provincia, tmp_pais, tmp_formacion_profesional, tmp_formacion_carrera, tmp_formacion_institucion, tmp_empresa_nombre, tmp_empresa_actividad, tmp_empresa_area, tmp_empresa_cargo, tmp_empresa_web, tmp_institucion_nombre, tmp_institucion_departamento, tmp_institucion_cargo, tmp_independiente, tmp_actividad_veterinaria, tmp_actividad_industria, tmp_actividad_agropecuaria, tmp_actividad_dueno, tmp_actividad_peq_animales, tmp_actividad_gran_animales, tmp_intereses_1, tmp_intereses_2, tmp_intereses_3, tmp_intereses_4, tmp_intereses_5, tmp_consumidor_final_pets, tmp_observaciones, tmp_sus_mot_digital, tmp_sus_2mas2_digital, tmp_sus_mot_impreso, tmp_sus_2mas2_impreso, tmp_sus_tipo_envio, tmp_sus_envios_enero, tmp_sus_envios_febrero, tmp_sus_envios_marzo, tmp_sus_envios_abril, tmp_sus_envios_mayo, tmp_sus_envios_junio, tmp_sus_envios_julio, tmp_sus_envios_agosto, tmp_sus_envios_septiembre, tmp_sus_envios_octubre, tmp_sus_envios_noviembre, tmp_sus_envios_diciembre, tmp_sus_invitado_CIVA, tmp_fuente, tmp_ultima_actualizacion, tmp_ejemplos, tmp_observaciones2, tmt_fecha
													FROM sus_usuario_gral
								INNER JOIN sus_suscripciones ON ssu_id = sug_id
                                 INNER JOIN sus_tmp_excel ON sug_correo_1 = tmp_correo_1
